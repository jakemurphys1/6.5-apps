...
},{"./models/models":2,"./views/views":3,"backbone":6,"jquery":27}],2:[function(require,module,exports){
"use strict";
var $=require("jquery");
var Backbone=require("backbone");
...
},{"../../templates/blog.hbs":4,"../../templates/select.hbs":5,"backbone":6,"jquery":27}],4:[function(require,module,exports){
"use strict";
...
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<!doctype html>\n<div id = \"selectForm\"><h1>Select Blog</h1></div>\n";
},"useData":true});
